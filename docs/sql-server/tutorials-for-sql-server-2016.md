...
- [sql-server-samples](../samples/wide-world-importers-what-is.md) GitHub リポジトリに提供されている [Wide World Importers](https://github.com/Microsoft/sql-server-samples) の新しいサンプルを確認します。 
...
|テクノロジ|説明|  
|--------------|---------------|  
|[Analysis Services チュートリアル (SSAS)](/analysis-services/analysis-services-tutorials-ssas)|[!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] テーブルまたは多次元モデルを開発および配置する方法について説明します。 また、PowerPivot などのツールを使用して、モデル内のデータを分析する方法についても説明します。|  
...
|[SQL Server Machine Learning チュートリアル](../machine-learning/tutorials/r-tutorials.md)|R または Python を使って [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] のデータを処理する方法について説明します。 R または Python のスクリプトを [!INCLUDE[tsql](../includes/tsql-md.md)] から実行します。|  
 ...
 - [SQL Server 2012 チュートリアル](/previous-versions/sql/sql-server-2012/hh231699(v=sql.110))  
  
 - [SQL Server 2008 R2 用のチュートリアル](/previous-versions/sql/sql-server-2008-r2/ms167593(v=sql.105))   
