...
**対処法:** この問題を解決するには、[このサポート技術情報の資料](https://support.microsoft.com/kb/955784)の「解決策」に記載されている指示に従って、ClusterName レジストリ エントリを更新してください。  
...
**対処法:** マップするソース データを格納している Excel ファイルのシート名から ; (セミコロン) を削除し、再試行してください。  
