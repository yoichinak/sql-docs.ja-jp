...
-   [Always On 可用性グループ ウィザードでのクォーラムの投票の構成のチェック](/archive/blogs/sqlalwayson/quorum-vote-configuration-check-in-alwayson-availability-group-wizards-andy-jing)  
