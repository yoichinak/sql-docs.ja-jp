---
description: RESTORE ステートメント (Transact-SQL)
...
以前のバージョンの [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] を使用して作成された **master**、**model**、および **msdb** のバックアップを [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] で復元することはできません。
