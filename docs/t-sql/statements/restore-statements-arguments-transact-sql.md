---
description: RESTORE ステートメントの引数 (Transact-SQL)
title: RESTORE の引数 (Transact-SQL)
ms.custom: ''
ms.date: 08/08/2018
ms.prod: sql
