...
## <a name="date-and-time-data-types"></a><a name="DateandTimeDataTypes"></a> 日付および時刻のデータ型
...
## <a name="date-and-time-functions"></a><a name="DateandTimeFunctions"></a> 日付と時刻関数
...
### <a name="function-that-return-system-date-and-time-values"></a><a name="GetSystemDateandTimeValues"></a> システムの日付と時刻値を返す関数
...
### <a name="functions-that-return-date-and-time-parts"></a><a name="GetDateandTimeParts"></a> 日付と時刻の要素を返す関数
...
### <a name="functions-that-return-date-and-time-values-from-their-parts"></a><a name="fromParts"></a> 要素から日付と時刻の値を返す関数
...
### <a name="functions-that-return-date-and-time-difference-values"></a><a name="GetDateandTimeDifference"></a> 日付と時刻の差の値を返す関数
...
### <a name="functions-that-modify-date-and-time-values"></a><a name="ModifyDateandTimeValues"></a> 日付と時刻の値を変更する関数
...
### <a name="functions-that-set-or-return-session-format-functions"></a><a name="SetorGetSessionFormatFunctions"></a> セッションの形式の関数を設定または返す関数
...
### <a name="functions-that-validate-date-and-time-values"></a><a name="ValidateDateandTimeValues"></a> 日付と時刻の値を検証する関数
...
## <a name="date-and-time-related-topics"></a><a name="DateandTimeRelatedTopics"></a> 日付と時刻に関連したトピック

|トピック|説明|
|-----------|-----------------|
|[FORMAT](../../t-sql/functions/format-transact-sql.md)|指定した形式とオプションのカルチャを使用して書式設定された値を返します。 文字列としての日付/時刻と数値のロケール依存の書式指定には FORMAT 関数を使用します。|
