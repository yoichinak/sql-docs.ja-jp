...
:::row:::
    :::column:::
        [SELECT 句](../../t-sql/queries/select-clause-transact-sql.md)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        [INTO 句](../../t-sql/queries/select-into-clause-transact-sql.md)
    :::column-end:::
    :::column:::
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [OPTION 句](../../t-sql/queries/option-clause-transact-sql.md)
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
