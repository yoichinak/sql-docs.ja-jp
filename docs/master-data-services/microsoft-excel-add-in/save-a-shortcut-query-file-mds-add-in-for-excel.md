---
description: ショートカット クエリ ファイルの保存 (Excel 用 MDS アドイン)
title: ショートカット クエリ ファイルの保存
...
-   [ショートカット クエリ ファイルの電子メールでの送信 (Excel 用 MDS アドイン)](../../master-data-services/microsoft-excel-add-in/email-a-shortcut-query-file-mds-add-in-for-excel.md)  
