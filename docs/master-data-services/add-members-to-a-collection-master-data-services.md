---
description: コレクションにメンバーを追加する (マスター データ サービス)
title: コレクションにメンバーを追加する
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
-   コレクションが存在する必要があります。 詳細については、「[コレクションを作成する (マスター データ サービス)](../master-data-services/create-a-collection-master-data-services.md)」を参照してください。  
