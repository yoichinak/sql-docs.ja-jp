---
description: データ フロー コンポーネントのデザイン時のメソッド
...
```  
 ...
 詳細については、[MSDN ライブラリ](../../../sql-server/index.yml)の「一般的な型変換」および「型コンバーターの実装」を参照してください。  
...
```  
 ...
 詳細については、[MSDN ライブラリ](../../../sql-server/index.yml)の「UI 型エディターの実装」を参照してください。  
