...
|Section|説明|
|-----------|---------------|
|[SSMA for Oracle の新機能](./what-s-new-in-ssma-for-oracle-oracletosql.md)|このバージョンの SSMA for Oracle の新機能|  
...
|[SSMA for Oracle のサポートを取得する](../sql-server-migration-assistant.md)|追加のサポートを受ける方法について説明します。|