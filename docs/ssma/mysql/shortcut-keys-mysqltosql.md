---
description: ショートカット キー (MySQLToSQL)
title: ショートカットキー (MySQLToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
