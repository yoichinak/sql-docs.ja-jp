---
title: SqlPackage スクリプト
description: SqlPackage.exe スクリプトを使用してデータベース開発タスクを自動化する方法について説明します。 例と使用可能なパラメーター、プロパティ、および SQLCMD 変数を表示します。
ms.prod: sql
...
## <a name="parameters-for-the-script-action"></a>スクリプト操作のパラメーター
