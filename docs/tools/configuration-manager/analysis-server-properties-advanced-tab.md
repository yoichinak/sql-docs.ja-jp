---
title: '[SQL Server Analysis Services のプロパティ] ダイアログ ボックス ([詳細設定] タブ)'
description: ダンプ ディレクトリやインスタンス ID など、[分析サーバーのプロパティ] ダイアログ ボックスの [詳細設定] タブのオプションについて説明します。
