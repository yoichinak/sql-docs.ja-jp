---
title: IRowsetFastLoad (OLE DB ドライバー) | Microsoft Docs
description: OLE DB Driver for SQL Server コンシューマーは IRowsetFastLoad インターフェイスを使用し、既存の SQL Server テーブルにデータをすばやく追加できます。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
