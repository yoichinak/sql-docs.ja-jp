...
description: SQL Server 用 Microsoft PDO_SQLSRV Driver for PHP の PDO::setAttribute 関数の API リファレンス。
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
|PDO::ATTR_DEFAULT_STR_PARAM|PDO|PDO::PARAM_STR_CHAR<br /><br />PDO::PARAM_STR_NATL|詳細については、「[PDO::quote](../../connect/php/pdo-quote.md)」にある例を参照してください。|
