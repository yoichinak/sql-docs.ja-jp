...
|datetime2<br /><br /> (SQL Server 2008 以降)|DateTime|<xref:System.Data.SqlDbType.DateTime2>|該当なし|<xref:System.Data.DbType.DateTime2>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
|datetimeoffset<br /><br /> (SQL Server 2008 以降)|DateTimeOffset|<xref:System.Data.SqlDbType.DateTimeOffset>|該当なし|<xref:System.Data.DbType.DateTimeOffset>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetDateTimeOffset%2A>|  
...
|numeric|Decimal (10 進数型)|<xref:System.Data.SqlDbType.Decimal>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetSqlDecimal%2A>|<xref:System.Data.DbType.Decimal>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetDecimal%2A>|  
...
|time<br /><br /> (SQL Server 2008 以降)|TimeSpan|<xref:System.Data.SqlDbType.Time>|該当なし|<xref:System.Data.DbType.Time>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetDateTime%2A>|  
...
|xml|Xml|<xref:System.Data.SqlDbType.Xml>|<xref:Microsoft.Data.SqlClient.SqlDataReader.GetSqlXml%2A>|<xref:System.Data.DbType.Xml>|該当なし|
