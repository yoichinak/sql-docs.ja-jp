---
description: setAsciiStream (java.lang.String, java.io.InputStream, long) メソッド
title: 入力ストリーム バイトへの setAsciiStream メソッド (long) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
