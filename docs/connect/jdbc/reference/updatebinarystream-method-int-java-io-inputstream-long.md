---
description: updateBinaryStream (int, java.io.InputStream, long) メソッド
title: updateBinaryStream メソッド (int, java.io.InputStream, long) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
