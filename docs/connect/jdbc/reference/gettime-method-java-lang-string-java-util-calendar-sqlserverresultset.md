---
description: getTime (java.lang.String, java.util.Calendar) メソッド (SQLServerResultSet)
title: getTime (java.lang.String, java.util.Calendar) メソッド (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
