---
description: SQLServerConnectionPoolDataSource のメンバー
...
|[getReference](../../../connect/jdbc/reference/getreference-method-sqlserverconnectionpooldatasource.md)|この DataSource オブジェクトへの参照が返されます。|  
