---
description: getObject (java.lang.String, java.util.Map) メソッド (SQLServerResultSet)
title: getObject (java.lang.String, java.util.Map) メソッド (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
