---
description: updateBinaryStream (java.lang.String, java.io.InputStream, int) メソッド
title: updateBinaryStream メソッド (java.io.InputStream, int) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
