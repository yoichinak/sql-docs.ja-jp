---
description: SQLServerBlob のメンバー
...
ms.locfileid: "99178393"
---
# <a name="sqlserverblob-members"></a>SQLServerBlob のメンバー
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  次の表は、[SQLServerBlob](../../../connect/jdbc/reference/sqlserverblob-class.md) クラスによって公開されるメンバーを示しています。  
...
|[length](../../../connect/jdbc/reference/length-method-sqlserverblob.md)|BLOB オブジェクト内のバイト数を返します。|  
|[position](../../../connect/jdbc/reference/position-method-sqlserverblob.md)|渡されたパターンと開始インデックスに基づいて、BLOB 内の指定されたパターンの位置を返します。|  
