...
Microsoft JDBC Driver 9.2 for SQL Server では、**mssql-jdbc-9.2.1.jre8.jar**、**mssql-jdbc-9.2.1.jre11.jar**、**mssql-jdbc-9.2.1.jre15.jar** の各クラス ライブラリ ファイルが提供されます。
...
JDBC Driver 9.2 を使用する場合は、**mssql-jdbc-9.2.1.jre8.jar**、**mssql-jdbc-9.2.1.jre11.jar**、または **mssql-jdbc-9.2.1.jre15.jar** が含まれるようにクラスパスを設定します。
...
**mssql-jdbc-9.2.1.jre8.jar**、**mssql-jdbc-9.2.1.jre11.jar**、または **mssql-jdbc-9.2.1.jre15.jar** ファイルが次の場所にインストールされます。
...
CLASSPATH ステートメントに [!INCLUDE[jdbcNoVersion](../../includes/jdbcnoversion_md.md)] が 1 つだけ含まれていることを確認します (**mssql-jdbc-9.2.1.jre8.jar**、**mssql-jdbc-9.2.1.jre11.jar**、または **mssql-jdbc-9.2.1.jre15.jar** など)。
