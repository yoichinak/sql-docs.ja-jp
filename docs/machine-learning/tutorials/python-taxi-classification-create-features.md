---
title: Python のチュートリアル:データの特徴量の作成
...
---
# <a name="python-tutorial-create-data-features-using-t-sql"></a>Python のチュートリアル:T-SQL を使用してデータの特徴量を作成する
...
生データから特徴量を作成するこの "*特徴量エンジニアリング*" プロセスは、高度な分析のモデリングにおいて重要な手順となり得ます。
...
次の回では、これらのデータの特徴量を利用し、Python による機械学習モデルを作成してトレーニングします。
