...
これは SQL Server 2019 (15.x) の Cumulative Update 9 (CU9) リリースです。 このリリースの SQL Server データベース エンジンのバージョンは、15.0.4102.2 です。 修正プログラムと機能強化の詳細については、<https://support.microsoft.com/help/5000642> を参照してください。
