...
description: この記事では、さまざまなバージョンの SQL Server のインスタンスに関するアップグレード情報を含むリソースへのリンクを示します。
ms.custom: ''
ms.date: 07/17/2017
ms.prod: sql
ms.reviewer: ''
