...
description: SQL Server で共通言語ランタイム (CLR) の厳密なセキュリティを構成する方法について説明します。 SAFE、EXTERNAL ACCESS、UNSAFE の各アクセス許可の解釈を制御します。
ms.custom: ''
ms.date: 06/20/2017
ms.prod: sql
