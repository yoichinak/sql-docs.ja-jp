...
description: locks オプションについて説明します。 これを使用して、SQL Server データベース エンジンでロックに使用されるメモリの量を制限する方法について説明します。
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
