---
title: データベース ミラーリングとデータベース スナップショット
description: SQL Server のレポート作成をオフロードする目的で、データベース スナップショットとデータベース ミラーリングを使用する場合の相互運用性について説明します。
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
