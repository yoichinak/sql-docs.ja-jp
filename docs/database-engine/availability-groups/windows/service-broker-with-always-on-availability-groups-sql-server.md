...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  ...
  このトピックでは、 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] で Service Broker を [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)]と共に使用できるように構成する方法について説明します。  
