---
title: 標準 .NET Framework データ プロバイダーを登録する | Microsoft Docs
description: サードパーティの .NET Framework データ プロバイダーを使用して Reporting Services レポート データセットのデータを取得するように、標準 .NET Framework データ プロバイダーを登録します。
ms.date: 05/24/2018
