---
title: SharePoint リストの接続の種類 | Microsoft Docs
description: データ ソースを構築する方法については、この記事の SharePoint リストの接続の種類に関する情報を参照してください。
ms.date: 05/10/2017
