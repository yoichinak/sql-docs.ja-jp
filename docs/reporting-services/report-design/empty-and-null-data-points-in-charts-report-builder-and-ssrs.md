---
title: グラフ内の空のデータ ポイントおよび NULL データ ポイント (レポート ビルダー) | Microsoft Docs
description: レポート ビルダーで、空の値や使用されているプレースホルダーがグラフでどのように処理されるか、また空のデータポイントと null データポイントがどのように表示されるかについて説明します。
ms.date: 05/30/2017
