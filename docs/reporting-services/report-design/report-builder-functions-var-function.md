---
title: Var 関数 (レポート ビルダー) | Microsoft Docs
description: Var 関数を使用すると、レポート ビルダーの式で指定したすべての非 NULL 数値の分散を戻すことができます。
ms.date: 03/07/2017
...
ms.locfileid: "98596713"
---
# <a name="report-builder-functions---var-function"></a>レポート ビルダー関数 - Var 関数
 ...
 *スコープ (scope)*  
 (**文字列**) 省略可。 この集計関数の適用先となるレポート アイテムを含むデータセット、グループ、またはデータ領域の名前を表す定数です。 *scope* を指定しない場合、現在のスコープが使用されます。  
