---
title: テーブル、マトリックス、および一覧 (レポート ビルダー) | Microsoft Docs
description: ページ分割されたレポート データを行と列で構成して表示する、レポート ビルダーのテーブル、マトリックス、および一覧の tablix データ領域について説明します。
ms.date: 03/14/2017
...
##  <a name="list"></a><a name="List"></a> 一覧  
