...
|Web パーツのタイトルの自動生成|レポート ビューアー Web パーツの名前とレポートの名前をダッシュでつないで自動生成されたタイトル。 レポートにタイトルがない場合は、レポート ファイルの名前が使用されます。 ページに Web パーツを追加すると、このタイトルが表示されます。 このチェック ボックスがオンの場合、ページが更新されるたびにタイトルが生成されます。|  
