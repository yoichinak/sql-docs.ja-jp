...
## <a name="prerequisites"></a>前提条件  
 ...
 詳細については、MSDN のプラットフォーム SDK ドキュメントの「 [Windows ファイアウォールを使用した接続](/windows/win32/wmisdk/connecting-to-wmi-remotely-with-vbscript) 」を参照してください。  
