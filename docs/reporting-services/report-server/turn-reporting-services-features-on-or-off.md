...
description: ネイティブ モードの Reporting Services で個々の機能をオフにする方法について説明します。 機能はさまざまな方法で構成できます。
ms.date: 06/10/2019
...
[レポート サーバー構成マネージャー (ネイティブ モード)](../install-windows/reporting-services-configuration-manager-native-mode.md)
