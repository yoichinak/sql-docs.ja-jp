...
description: SQL Server Management Studio を使用してリソース正常性ポリシーの定義を変更し、SQL Server のパフォーマンス データをより適切に評価できるようにする方法について説明します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
