...
## <a name="arguments"></a>引数  
 db_id ('*database_name*')  
 [DB_ID ()](../../t-sql/functions/db-id-transact-sql.md)関数の呼び出し。 この関数は、データベース名を受け取り、指定されたデータベースを検索するために使用 sys.dm_fts_index_keywords_position_by_document データベース ID を返します。  
