...
|sys.dm_xe_session_events sys.dm_xe_session_events.event_package_guid、<br /><br /> sys.dm_xe_session_events sys.dm_xe_session_events.event_name|sys.dm_xe_objects.name、<br /><br /> sys.dm_xe_objects.package_guid|多対一|  
