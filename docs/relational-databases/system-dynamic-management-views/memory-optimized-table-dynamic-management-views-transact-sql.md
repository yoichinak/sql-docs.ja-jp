...
description: SQL Server で In-Memory OLTP で使用される動的管理ビューおよびオブジェクトカタログビュー SQL Server について説明します。
...
[!INCLUDE[sql-asdb-asdbmi](../../includes/applies-to-version/sql-asdb-asdbmi.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]In-Memory OLTP では、次の動的管理ビュー (dmv) が使用されます。  
...
次のオブジェクトカタログビューは In-Memory OLTP で特に使用されます。
