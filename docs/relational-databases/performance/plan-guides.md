...
description: SQL Server でクエリのテキストを直接変更することなくクエリのパフォーマンスを最適化できるプラン ガイドについて説明します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
