...
description: SQL Server では、ファイル復元はデータベース全体を復元することなく 1 つ以上の破損したファイルに適用されます。
ms.custom: ''
ms.date: 03/24/2017
ms.prod: sql
...
-   [Restore.SqlRestore メソッド (サーバー) (SMO)](/dotnet/api/microsoft.sqlserver.management.smo.restore.sqlrestore)   
