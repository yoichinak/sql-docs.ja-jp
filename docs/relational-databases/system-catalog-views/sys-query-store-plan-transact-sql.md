...
|-----------------|---------------|-----------------|
|**plan_id**|**bigint**|主キー|  
|**query_id**|**bigint**|外部キー。 [Sys.query_store_query &#40;transact-sql&#41;](../../relational-databases/system-catalog-views/sys-query-store-query-transact-sql.md)に結合します。|  
...
|**avg_compile_duration**|**float**|コンパイルの統計を計画します。 <br/>**注:** Azure Synapse Analytics は常にゼロ (0) を返します。|  
|**last_compile_duration**|**bigint**|コンパイルの統計を計画します。 <br/>**注:** Azure Synapse Analytics は常にゼロ (0) を返します。|  
|**plan_forcing_type**|**int**|プランの強制型。<br /><br />0: なし<br /><br />1: 手動<br /><br />2: AUTO|  
