...
description: SQL Server Management Studio または Transact-SQL を使用して、SQL Server 内のデータベースの互換性レベルを表示または変更する方法について説明します。
ms.custom: ''
ms.date: 11/24/2017
ms.prod: sql
