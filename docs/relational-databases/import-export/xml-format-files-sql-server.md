...
description: SQL Server 2019 には、SQL Server のテーブルにデータを一括インポートする目的で使用する XML フォーマット ファイルを記述するための構文を定義した XML スキーマが用意されています。
ms.custom: ''
ms.date: 01/11/2019
ms.prod: sql
...
###  <a name="c-omitting-a-data-field"></a><a name="OmitField"></a> C. データ フィールドをスキップする場合  
