...
description: メモリ最適化テーブルおよびネイティブ コンパイル ストアド プロシージャのトランザクションにの概要と、それらとディスク ベースのテーブルのトランザクションとの違いについて説明します。
ms.custom: ''
ms.date: 01/16/2018
ms.prod: sql
...
- [データベース エンジンでの行のバージョン管理に基づく分離レベル](/previous-versions/sql/sql-server-2008-r2/ms177404(v=sql.105))  
