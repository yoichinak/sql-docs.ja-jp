...
description: Blocked Process Report イベント クラスは、指定された時間より長い間、SQL Server でタスクがブロックされていることを示します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
|**Duration**|**bigint**|プロセスがブロックされていた時間 (マイクロ秒)。|13|はい|  
