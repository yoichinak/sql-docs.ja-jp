...
description: Audit Logout イベント クラスは、ユーザーが SQL Server からサインアウトしたことを示します。 この記事では Audit Logout イベント クラスのデータ列について説明します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
|**StartTime**|**datetime**|使用可能な場合は関連する Audit Login イベントの StartTime。|14|はい|  
