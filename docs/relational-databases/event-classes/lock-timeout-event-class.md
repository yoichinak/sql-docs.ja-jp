...
description: Lock:Timeout イベント クラスは、SQL Server のリソースに対するブロッキング ロックが原因で、そのリソースのロック要求がタイムアウトしたことを示します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>参照  
 ...
 [Lock:Timeout &#40;timeout &#62; 0&#41; イベント クラス](../../relational-databases/event-classes/lock-timeout-timeout-0-event-class.md)   
