...
```  
 ...
 コードは次のようになります。 [SQL](./sql-property.md)プロパティに割り当てられたコマンドは、***AuthorById** _ 識別子と一致し、作成者 Michael O'Leary の行を取得します。 _ *DataControl** オブジェクト **レコードセット** プロパティは、コードの便宜的な方法として、切断された [レコードセット](../ado-api/recordset-object-ado.md) オブジェクトに割り当てられます。  
