...
## <a name="propertiescollections"></a>プロパティ/コレクション  
 ...
 [プロバイダーのプロパティ](./provider-property-ado.md)  
  
 [State プロパティ](./state-property-ado.md)  
  
 [Version プロパティ](./version-property-ado.md)  
...
## <a name="events"></a>イベント  
 ...
 [インフォメッセージイベント](./infomessage-event-ado.md)  
  
 [接続イベント](./willconnect-event-ado.md)  
  
 [イベントの実行](./willexecute-event-ado.md)  
