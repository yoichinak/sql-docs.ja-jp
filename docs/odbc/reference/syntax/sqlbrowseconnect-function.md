 ...
 *StringLength2Ptr*  
 OutputOutconnectionstring で返すことができる文字の合計数 (null 終端を除く) \* 。 返すことのできる文字数が *Bufferlength* 以上の場合、 \* *outconnectionstring* 内の接続文字列は *bufferlength* に切り捨てられ、null 終了文字の長さを引いたものになります。  
