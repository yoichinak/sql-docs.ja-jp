...
>   
>  Sqlstatistics によって返される列には、 **sqlstatistics** によって返されないものがあります。 たとえば、 **Sqlcolumns** は、式またはフィルターに対して作成されたインデックスの列を返しません (例: SALARY + 福利厚生または DEPT = 0012)。  
